...
namespace ToDoAPI.Persistence.Migrations
{
    ...
    [Migration("20230219153219_SecondMigration")]
            ...
            modelBuilder.Entity("ToDoAPI.Persistence.Models.Status", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedAt = new DateTime(2023, 2, 19, 19, 32, 19, 792, DateTimeKind.Local).AddTicks(6910),
                            ModifiedAt = new DateTime(2023, 2, 19, 19, 32, 19, 792, DateTimeKind.Local).AddTicks(6922),
                            StatusDefinition = "Active"
                        },
                        new
                        {
                            ID = 2,
                            CreatedAt = new DateTime(2023, 2, 19, 19, 32, 19, 792, DateTimeKind.Local).AddTicks(6926),
                            ModifiedAt = new DateTime(2023, 2, 19, 19, 32, 19, 792, DateTimeKind.Local).AddTicks(6926),
                            StatusDefinition = "Done"
                        },
                        new
                        {
                            ID = 3,
                            CreatedAt = new DateTime(2023, 2, 19, 19, 32, 19, 792, DateTimeKind.Local).AddTicks(6927),
                            ModifiedAt = new DateTime(2023, 2, 19, 19, 32, 19, 792, DateTimeKind.Local).AddTicks(6927),
            ...
            modelBuilder.Entity("ToDoAPI.Persistence.Models.ToDo", b =>
                {
                    ...
                    b.HasOne("ToDoAPI.Persistence.Models.Status", null)
                        .WithMany()

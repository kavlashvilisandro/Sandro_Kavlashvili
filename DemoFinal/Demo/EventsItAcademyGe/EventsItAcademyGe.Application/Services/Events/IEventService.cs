...
namespace EventsItAcademyGe.Application.Services
{
    public interface IEventService
    {
        ...
        public Task<List<IEventResponseModel>> GetAllPendingEvents(CancellationToken token);

        public Task ActivatePendingEvent(int EventID, CancellationToken token);

        public Task<IEventResponseModel> GetEventByID(int EventID, CancellationToken token);
    }
}
